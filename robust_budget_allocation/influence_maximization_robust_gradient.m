function [out_struct_max] = influence_maximization_robust_gradient(param_max, param_min, R_cell)
...
for kk=1:param_max.maxiters
    ...
    %[xmin_unscaled,Fmin,out_struct,certified_suboptimality_gap] = minimize_submodular_constrained(F,R_cell,param_min);
